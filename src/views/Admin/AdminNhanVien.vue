        ...
        <div class="row m-0 p-0">
          ...
          <div class="col-md-10" style="padding-top: 40px;">
            <div style="background:#E6E6FA" class="mt-3 p-2">
              <h1>Quản Lý Danh Sách Nhân Viên</h1><hr/>
              ...
              <tr v-for="(dh, index) of donhang" :key="dh._id">
                ...
                <td>
                  <div v-if="dh.trangthai == 'Chưa xử lý'" class="">
                    <button @click="updateTrangThai(dh._id)" class="btn btn-primary">
                      {{ dh.trangthai }}
                    </button>
                  </div>
                  <div v-else>
                    <button class="btn btn-primary" disabled>{{dh.trangthai}}</button>
                  </div>
                </td>
                <td>
                  <div class="">
                    <button @click="goToDetail(dh._id)" class="btn btn-secondary">
                      Chi tiết
                    </button>
                    <button
