<template>
  <div id="AddProductPage">
    <div class="container-fuild">
      <AppNav/>
      <div class="row m-0 p-9">
        <div class="col-md-2">
          <Sidebar/>
        </div>
        <div class="col-md-10 d-flex justify-content-center" style="padding-top: 40px;"> 
        <Form class="p-5 col-sm-8" @submit="handleAddProduct" :validation-schema="addProductFormSchema">
          ...
          <div class="mb-3">
            ...
            <Field as="select" name="maloaisp" v-model="product.maloaisp" class="form-select">
          ...
          <div class="mb-3">
            ...
            <div class="form-check form-check-inline">
              <Field class="form-check-input" type="radio" v-model="product.noibat" name="noibat" value="1"/>
              <label class="form-check-label">Có</label>
            </div>
            <div class="form-check form-check-inline">
              <Field class="form-check-input" type="radio" v-model="product.noibat" name="noibat" value="0"/>
          ...
          <div class="mb-3">
            ...
            <div class="form-check form-check-inline">
              <Field class="form-check-input" type="radio" v-model="product.moi" name="moi" value="1"/>
              <label class="form-check-label">Có</label>
            </div>
            <div class="form-check form-check-inline">
              <Field class="form-check-input" type="radio" v-model="product.moi" name="moi" value="0"/>
              <label class="form-check-label" >Không</label>
            </div>
          ...
          <div class="mb-3">
            ...
            <div class="form-check form-check-inline">
              <Field class="form-check-input" type="radio" v-model="product.dangban" name="dangban" value=1 />
              <label class="form-check-label">Đang bán</label>
            </div>
            <div class="form-check form-check-inline">
              <Field class="form-check-input" type="radio" v-model="product.dangban" name="dangban" value=0 />
...
export default {
  ...
  data() {
    const addProductFormSchema = yup.object().shape({ 
            ...
            docon: yup
                .string()
                .required("Độ cồn không được để trống."),
            dungtich: yup
                .string()
                .required("Dung tích không được để trống."),
            giaban: yup
                .string()
