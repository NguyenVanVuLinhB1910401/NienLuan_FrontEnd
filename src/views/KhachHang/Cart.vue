<template>
  <div class="container-fuild vh-100" id="CartPage">
    <div>
      <NavbarKH />
    </div>
    <div class="" style="background-color: #7FFFD4">
      <div class="row d-flex justify-content-center px-3" style="padding-top: 80px">
        <div class="col pt-2">
          <p>
